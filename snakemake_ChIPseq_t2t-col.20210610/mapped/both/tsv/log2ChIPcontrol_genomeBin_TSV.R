...
# Usage:
# ./log2ChIPcontrol_genomeBin_TSV.R WT_CENH3_Rep1_ChIP_SRR4430537 WT_CENH3_Rep1_input_SRR4430555 t2t-col.20210610 both 10000 101
# ./log2ChIPcontrol_genomeBin_TSV.R LoCENH3_Rep1_ChIP_SRR4430543 WT_CENH3_Rep1_input_SRR4430555 t2t-col.20210610 both 10000 101
# ./log2ChIPcontrol_genomeBin_TSV.R ZmCENH3_Rep1_ChIP_SRR4430549 WT_CENH3_Rep1_input_SRR4430555 t2t-col.20210610 both 10000 101
...
sampleProfile <- read.table(paste0(sampleName, "_MappedOn_", refbase, "_lowXM_",
                            ...
                            header = T)
if(controlName == "WT_REC8_Myc_Rep1_input") {
  controlProfile <- read.table(paste0("/home/ajt200/analysis/REC8_pooled/snakemake_ChIPseq_", refbase, "/mapped/",
                                      align, "/tsv/",
                                      controlName, "_MappedOn_", refbase, "_lowXM_",
                                      align, "_sort_norm_binSize", genomeBinName, ".tsv"),
                               header = T)
} else if(controlName == "WT_CENH3_Rep1_input_SRR4430555") {
  controlProfile <- read.table(paste0("/home/ajt200/analysis/CENH3_seedlings_Maheshwari_Comai_2017_GenomeRes/snakemake_ChIPseq_", refbase, "/mapped/",
                                      align, "/tsv/",
                                      controlName, "_MappedOn_", refbase, "_lowXM_",
                                      align, "_sort_norm_binSize", genomeBinName, ".tsv"),
                               header = T)
} else {
  if(!(controlName %in% c("WT_REC8_Myc_Rep1_input", "WT_CENH3_Rep1_input_SRR4430555"))) {
    stop("controlName is not WT_REC8_Myc_Rep1_input or WT_CENH3_Rep1_input_SRR4430555")
  }
}
